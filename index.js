...
Lexxy.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By BarrGans*'})
break
case 'gfx3':
case 'gfx4':
...
Lexxy.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By Barr Gans*'})
break
case 'gfx6':
if (args.length ==0) return reply(`Text Nya Mana? Contohnya\n${prefix+command} Lexxy`)
sticWait(from)
...
Lexxy.sendMessage(from, asupan, video, {quoted: mek, caption: 'BarrGans'})
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
Lexxy.sendMessage(from, asupan, image, {quoted: mek, caption: 'barrGans'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
Lexxy.sendMessage(from, oke, image, {quoted: mek, caption: 'barrGans'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
Lexxy.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: 'BarrGans'})
break
case 'tinyurl':
...
Lexxy.sendMessage(from, harta, image, {quoted: mek, caption: 'BarrGans'})
break
...
Lexxy.sendMessage(from, pornhub, image, {caption: `BarrGans`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
Lexxy.sendMessage(from, girlneko, image, {caption: `BarrGans`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
